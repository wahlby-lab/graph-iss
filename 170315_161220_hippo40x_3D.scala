...
//$OPT --java-heap 4096
//$OPT -d /home/gabriele/TissueMaps_ExeDir/result_170315_161220_hippo_4_1_40x_3d
...
object pipeline {
	...
	val dataset_folder = INPUT(path="/data/project_data/170315_161220_hippo_4_1_40x")
	...
	// REGISTRATION
	val registration = BashEvaluate(var1=prepro_pipeline_path, var2=img_CSV, param1="8", param2="rigid", param3="Nuclei", param4="128", param5="1", script="""
				source activate pgm_pipeline
	...
	for ((k,f)<-iterArray(allTiles).take(1)) { //take tiles idecies
		...
		//main_files.retain((k1,v) => "%s".format(k1) == "9_5_tif") /////
