...
//$OPT --java-heap 4096
//$OPT -d /home/gabriele/TissueMaps_ExeDir/result_170315_161220_hippo_4_1_40x_2d
...
object pipeline {
	...
	val dataset_folder = INPUT(path="/data/project_data/170315_161220_hippo_4_1_40x_MIP")
	...
	mode_percent._custom("cpu") ="1"
        ...
        val registration = BashEvaluate(var1=prepro_pipeline_path, var2=img_CSV, param1="5", param2="rigid", param3="Nuclei", param4="DO", script="""source activate pgm_pipeline
                              ...
                              source deactivate """)
        registration._custom("partition") = "-p p16"
