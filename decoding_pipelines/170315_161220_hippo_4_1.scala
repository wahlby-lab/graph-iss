...
//$OPT --java-heap 4096
//$OPT -d /home/gabriele/TissueMaps_ExeDir/result_170315_161220_hippo_4_1
...
object pipeline {
	...
	val postpro_pipeline_path = INPUT(path="/home/gabriele/sourceCode_repo/graph-iss/postPro_pipeline")
	postpro_pipeline_path._execute = "once"
	val dataset_folder = INPUT(path="/data/project_data/170315_161220_hippo_4_1")
	dataset_folder._execute = "once"
	val tagList = INPUT(path="/home/gabriele/sourceCode_repo/graph-iss/data/tagList_99-gene.csv")
